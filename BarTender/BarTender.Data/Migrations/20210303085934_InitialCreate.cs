        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RecipeBy = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_UsersLikes_Drinks_DrinkId",
                        column: x => x.DrinkId,
                        principalTable: "Drinks",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IngredientsInfoId = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_DrinksIngredients_IngredientsInfos_IngredientsInfoId",
                        column: x => x.IngredientsInfoId,
            ...
            migrationBuilder.CreateTable(
                name: "DrinksIngredientsInfo",
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    DrinkId = table.Column<string>(type: "nvarchar(450)", nullable: true),
                    IngredientsInfoId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_DrinksIngredientsInfo", x => x.Id);
                    table.ForeignKey(
                        name: "FK_DrinksIngredientsInfo_Drinks_DrinkId",
                        column: x => x.DrinkId,
                        principalTable: "Drinks",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_DrinksIngredientsInfo_IngredientsInfos_IngredientsInfoId",
                        column: x => x.IngredientsInfoId,
                        principalTable: "IngredientsInfos",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DrinksIngredients_IngredientsInfoId",
                table: "DrinksIngredients",
                column: "IngredientsInfoId");

            migrationBuilder.CreateIndex(
                name: "IX_DrinksIngredientsInfo_DrinkId",
                table: "DrinksIngredientsInfo",
                column: "DrinkId");

            migrationBuilder.CreateIndex(
                name: "IX_DrinksIngredientsInfo_IngredientsInfoId",
                table: "DrinksIngredientsInfo",
                column: "IngredientsInfoId");
